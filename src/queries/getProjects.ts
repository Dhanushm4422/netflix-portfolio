...
export async function getProjects() {
  return [
    ...
    { title: "Health Camp Management System", description: "Developed a mobile app platform for organizing and managing free health camps with emergency services.", techUsed: "React Native, Firebase", image: { url: p11 }, githubLink: "https://github.com/Dhanushm4422/Health_Camp.git" },
    ...
    { title: "Solar Panel Installation System", description: "Developed a dashboard in ThingsBoard IoT platform for monitoring solar panel installations.", techUsed: "Angular, JavaScript, HTML, CSS, Bootstrap, AWS, ThingsBoard", image: { url: p4 }, githubLink: "" },
    ...
    { title: "Mario Club Website", description: "Designed a captivating front-end interface for the Mario Club website using only HTML and CSS.", techUsed: "HTML, CSS", image: { url: p9 }, githubLink: "https://github.com/Dhanushm4422/Marioclub.git" },
